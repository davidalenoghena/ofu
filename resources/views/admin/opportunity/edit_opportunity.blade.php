        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{ route('update.opportunity', ['id' => $opportunity->id]) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Status
                        </label></div>
                            <div class="col-12 col-md-9"><input type="text" id="status" name="status" value="{{ $opportunity->status }}" class="form-control" required></div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">First Detail
                        </label></div>
                            <div class="col-12 col-md-9"><input type="text" id="detail_1" name="detail_1" value="{{ $opportunity->detail_1 }}" class="form-control" required></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Second Detail
                        </label></div>
                            <div class="col-12 col-md-9"><input type="text" id="detail_2" name="detail_2" value="{{ $opportunity->detail_2 }}" class="form-control" required></div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Word</label></div>
                            <div class="col-12 col-md-9"><textarea name="word" id="elm1" rows="5" class="form-control">{{ $opportunity->word }}</textarea required></div>
                    </div>
