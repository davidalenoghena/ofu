...
<head>
  ...
  <title>Blog Oppurtunity for undergraduates</title>
   <!-- Favicons -->
  ...
  <link href="{{ asset('blog_assets/vendor/line-awesome/css/line-awesome.min.css') }}" rel="stylesheet">
  <link href="{{ asset('blog_assets/vendor/owl.carousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
  <link href="{{ asset('blog_assetsvendor/aos/aos.css') }}" rel="stylesheet">
